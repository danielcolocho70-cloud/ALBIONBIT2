...
- Cualquier persona que tenga el enlace puede entrar y escribir el nombre que quiere mostrar.
...
- El botón `Soy el organizador` solo puede ser reclamado por la primera persona que lo pulse; las demás aparecen como espectadores.
